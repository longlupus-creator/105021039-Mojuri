...
<img alt="Banner Image" src="/media/banner/banner-about-1.jpg"/>
</a>
</div>
</div>
</div>
...
<div class="banner-image hover-opacity">
<a href="/shop-grid-left">
<img alt="Banner Image" src="/media/banner/banner-about-2.jpg"/>
</a>
</div>
</div>
</div>
...
<div class="banner-image hover-opacity">
<a href="/shop-grid-left">
<img alt="Banner Image" src="/media/banner/banner-about-3.jpg"/>
</a>
</div>
</div>
</div>
...
<img alt="intro" height="333" src="/media/banner/intro-about-1.jpg" width="262"/>
</div>
</div>
<div class="col-md-6">
<div class="intro-image right animation-horizontal hover-opacity">
<img alt="intro" height="419" src="/media/banner/intro-about-2.jpg" width="330"/>
</div>
</div>
</div>
</div>
...
<img alt="intro" height="440" src="/media/banner/intro-about-3.jpg" width="600"/>
</div>
<div class="section-column right">
<div class="intro-wrap">
...
export default function About() {
  return <HtmlBlock html={pageHtml} className="mojuri-page mojuri-page-about" />
}
