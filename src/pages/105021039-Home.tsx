...
<img alt="Image Slider" height="1080" src="/media/slider/1-1.jpg" width="1920"/>
</div>
...
<div class="item-content">
<div class="content-image">
<img alt="Image Slider" height="1080" src="/media/slider/1-2.jpg" width="1920"/>
</div>
<div class="item-info horizontal-start vertical-middle">
<div class="content">
...
<div class="item-content">
<div class="content-image">
<img alt="Image Slider" height="1080" src="/media/slider/1-3.jpg" width="1920"/>
</div>
<div class="item-info horizontal-start vertical-middle">
<div class="content">
...
<img alt="Banner Image" height="457" src="/media/banner/banner-1-1.jpg" width="630"/>
</a>
</div>
...
<a class="button" href="/shop-grid-left">Shop Now</a>
</div>
</div>
</div>
</div>
...
<div class="banner-image">
<a href="/shop-grid-left">
<img alt="Banner Image" height="457" src="/media/banner/banner-1-2.jpg" width="450"/>
</a>
</div>
...
<a class="button center" href="/shop-grid-left">Shop Now</a>
</div>
</div>
</div>
</div>
...
<div class="banner-image">
<a href="/shop-grid-left">
<img alt="Banner Image" height="457" src="/media/banner/banner-1-3.jpg" width="630"/>
</a>
</div>
<div class="banner-wrapper-infor">
<div class="info">
...
<div class="block-title"><h2>Top Categories</h2></div>
<div class="block-content">
<div class="product-cats-list slick-wrap">
<div class="slick-sliders content-category" data-columns="5" data-columns1="5" data-columns1440="5" data-columns2="3" data-columns3="3" data-columns4="2" data-dots="0" data-nav="1" data-slidestoscroll="true">
<div class="item item-product-cat slick-slide">
<div class="item-product-cat-content">
<a href="/shop-grid-left">
<div class="item-image animation-horizontal">
<img alt="Bracelets" height="258" src="/media/product/cat-1.jpg" width="258"/>
</div>
</a>
...
<a href="/shop-grid-left">
<div class="item-image animation-horizontal">
<img alt="Charms" height="258" src="/media/product/cat-2.jpg" width="258"/>
</div>
</a>
<div class="product-cat-content-info">
<h2 class="item-title">
...
<a href="/shop-grid-left">
<div class="item-image animation-horizontal">
<img alt="Earrings" height="258" src="/media/product/cat-3.jpg" width="258"/>
</div>
</a>
<div class="product-cat-content-info">
<h2 class="item-title">
...
<a href="/shop-grid-left">
<div class="item-image animation-horizontal">
<img alt="Necklaces" height="258" src="/media/product/cat-4.jpg" width="258"/>
</div>
</a>
<div class="product-cat-content-info">
<h2 class="item-title">
...
<a href="/shop-grid-left">
<div class="item-image animation-horizontal">
<img alt="Rings" height="258" src="/media/product/cat-5.jpg" width="258"/>
</div>
</a>
<div class="product-cat-content-info">
<h2 class="item-title">
...
<div class="intro-btn">
<a class="button button-black button-arrow animation-horizontal" href="/shop-grid-left">LEARN MORE</a>
</div>
</div>
</div>
<div class="section-column right">
<a href="#">
<img alt="intro" class="hover-opacity" height="674" src="/media/banner/intro-1.jpg" width="820"/>
</a>
</div>
</div>
</div>
...
<div class="banner-image">
<a href="/shop-grid-left">
<img alt="Banner Image" height="496" src="/media/banner/banner-1-4.jpg" width="856"/>
</a>
</div>
<div class="banner-wrapper-infor">
<div class="info">
...
<a class="button button-outline thick-border border-white button-arrow" href="/shop-grid-left">Explore</a>
</div>
</div>
</div>
</div>
...
<div class="banner-image">
<a href="/shop-grid-left">
<img alt="Banner Image" height="496" src="/media/banner/banner-1-5.jpg" width="856"/>
</a>
</div>
<div class="banner-wrapper-infor">
<div class="info">
...
<div class="slick-sliders" data-columns="3" data-columns1="2" data-columns2="1" data-columns3="1" data-columns4="1" data-dots="0" data-nav="1" data-slidestoscroll="true">
...
<div class="thumbnail">
<img alt="" height="110" src="/media/testimonial/1.jpg" width="110"/>
</div>
...
<div class="testimonial-image image-position-top">
<div class="thumbnail">
<img alt="" height="110" src="/media/testimonial/2.jpg" width="110"/>
</div>
<div class="testimonial-info">
...
<div class="testimonial-image image-position-top">
<div class="thumbnail">
<img alt="" height="110" src="/media/testimonial/3.jpg" width="110"/>
</div>
<div class="testimonial-info">
...
<div class="testimonial-image image-position-top">
<div class="thumbnail">
<img alt="" height="110" src="/media/testimonial/4.jpg" width="110"/>
</div>
<div class="testimonial-info">
...
<div class="slick-sliders" data-columns="5" data-columns1="4" data-columns1440="4" data-columns2="3" data-columns3="2" data-columns4="1" data-nav="0">
<div class="item slick-slide">
<div class="item-image animation-horizontal">
<a href="#">
...
function HomeProductSection() {
  ...
  const { data: trendingResponse } = useQuery({
    ...
    queryFn: () => api.getProducts({ featured: true, limit: 4 }),
  })
  ...
  return (
    <section className="section-padding section-container p-l-r dynamic-section">
      <div className="block-title text-center">
        <h2>Trending Jewelry</h2>
      </div>
      <div className="row">
        {[...trending, ...latest.filter((item) => !trending.some((product) => product.id === item.id))].slice(0, 8).map((product) => (
...
export default function Home() {
  return (
    <>
      <HtmlBlock html={pageHtml.replaceAll('/shop-grid-left', '/shop')} className="mojuri-page mojuri-index" />
      <HomeProductSection />
    </>
  )
}
